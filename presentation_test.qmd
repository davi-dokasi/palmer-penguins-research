...
ggplot(data = data, aes(x = x)) +
  ...
  stat_function(fun = dnorm,
                ...
                size = 1) +
  theme_minimal() +
  labs(subtitle = "Espécie Adelie considerando o comprimento da nadadeira",
...
ggplot(data = data, aes(x = x)) +
  ...
  labs(title = "Curva Normal das Médias Geradas pelo BootStraping considerando IC",
       ...
       y = "Densidade",
       fill = "Distribuição") +
  geom_text(x = 191.5, y = 0.7, label = "Limite Superior: 190.9 mm ", alpha = 0.03) +
  geom_text(x = 191.458, y = 0.62, label = "Limite Inferior: 188.9 mm ", alpha = 0.03)
...
grid.arrange(g11,g22,g33,g44,g55,g66)
```

### Comparação

Limites Inferiores e Superiores para as espécies
