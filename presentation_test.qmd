...
ggplot(data = data, aes(x = x)) +
  ...
  labs(title = "Curva Normal das Médias Geradas pelo BootStraping considerando IC",
       ...
       y = "Densidade",
       fill = "Distribuição") +
  geom_text(x = 191.5, y = 0.7, label = "Limite Inferior: 188.9 mm ", alpha = 0.03) +
  geom_text(x = 191.458, y = 0.62, label = "Limite Superior: 190.9 mm ", alpha = 0.03)
...
g4 <- ggplot(data = data.frame(x = repeticoes_media_gentoo), aes(x = x)) +
  ...
  labs(title = "Curva Normal das médias geradas pelo BootStraping considerando IC",
      ...
      x = "Comprimento da Nadadeira (mm)",
      y = "Densidade") +
  geom_text(x = 218.8, y = 0.7, label = "Limite Inferior: 216.1 mm ", alpha = 0.02) +
  geom_text(x = 218.8418, y = 0.6, label = "Limite Superior: 218.2 mm ", alpha = 0.02)
...
g6 <- ggplot(data = data.frame(x = repeticoes_media_chinstrap), aes(x = x)) +
  ...
  labs(title = "Curva Normal das médias geradas pelo BootStraping considerando IC",
      ...
      x = "Comprimento da Nadadeira (mm)",
      y = "Densidade") +
  geom_text(x = 197.5, y = 0.64, label = "Limite Inferior: 194.6 mm", alpha = 0.02) +
  geom_text(x = 197.54, y = 0.54, label = "Limite Superior: 196.9 mm", alpha = 0.02)
