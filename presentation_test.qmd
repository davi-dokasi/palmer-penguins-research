...
## Teste de Hipótese!{.incremental}
 ...
 - Objetivo do Teste: Investigar se a proporção de pinguins das espécies Adélie, Chinstrap e Gentoo no conjunto de dados Palmer Penguins difere significativamente de uma distribuição equitativa, com uma proporção hipotética de 0.33 e alpha 0.5 para cada espécie.
